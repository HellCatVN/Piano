	...
	$.fn.pianoSnsShare = function(options){
		...
		var defaults = {
				tsina:{//分享到新浪微博 
					...
					appkey : 2220906864,								//新浪微博的appkey
					pic : './images/piano.jpg'	//图片默认是
				},
				renren:{//分享到人人网
					resourceUrl: window.location.href,	 				//分享的url默认是当前页面
					srcUrl : window.location.href,						//分享的url默认是当前页面
					title : document.title,								//分享的内容默认是当前页面的title
					appkey : 243319,									//人人的appkey
					pic : './images/piano.jpg'	//图片默认是-piano
				},
				tqq:{//分享到腾讯微博
					url : window.location.href,							//分享的url默认是当前页面
					title : document.title,								//分享的内容默认是当前页面的title
					appkey : 801435972,									//腾讯微博的appkey
					pic : './images/piano.jpg'	//图片默认是-piano
				},
				tqzone:{//分享到腾讯微博
					url : window.location.href,							//分享的url默认是当前页面
					title : document.title,								//分享的内容默认是当前页面的title
					appkey : 100566135,									//腾讯微博的appkey
					pic : './images/piano.jpg'	//图片默认是-piano
				}
			},
